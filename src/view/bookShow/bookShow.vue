...
<div class="bookShow">
    ...
    <div class="wordcloud" v-if="showbook">
       ...
       <div class="wcText"> <p style="font-size:32px;font-family:'英文手写花体'">Your Wordcloud</p> <el-divider></el-divider><p class="intro">  根据您的词云图结果，我们分析得出您兴趣权重偏向于计算机类，并致力于前端开发与游戏开发。我们将为您展示出您的适合书籍</p> </div>
    </div>
    </el-col>
